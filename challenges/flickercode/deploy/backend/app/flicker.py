...
def gif_flicker_default(code, field_width=30, space_width=15, height=50, wait=50):
    ...
    images[0].save('/var/www/vhosts/pogo-muenchen.de/arwes.pogo-muenchen.de/static/img/flicker.gif', save_all=True, append_images=images[1:], optimize=True, duration=wait, loop=0, disposal=2)

def gif_flicker_custom(code, outputfile, field_width=30, space_width=15, height=50, wait=50):
    color_count = 4
    ...
    images[0].save(outputfile, save_all=True, append_images=images[1:], optimize=False, duration=wait, loop=0, disposal=2)
    #images[0].save('my-app/public/static/img/flicker.gif', save_all=True, append_images=images[1:], optimize=False, duration=wait, loop=0, disposal=2)
