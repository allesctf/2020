...
print("The flag had a lot of visitors and wants to be kept alone. So its my job to keep anyone out")
print("Only real skilled hackers are allowed here. Once you have proven yourself worthy, the flag is yours")

while True:
    try:
        currentInput = input("Speak friend and enter: ")
